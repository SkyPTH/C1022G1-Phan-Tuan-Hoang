            ...
            <form class="d-flex" role="search">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <c:if test="${sessionScope.nameAccount != null}">
                        <li>
                            <a style="position: relative; right: 35px; top: 8px"
                        ...
                        <li class="nav-item mx-2"><a href="/user?action=logout"
                                                     ...
                                                     aria-current="page"> <i
                                style="position: absolute; right: 190px; width: 30px; padding-top: 5px; color: white"
...
<div class="row m-0">
    <div class="row ms-0 me-0 p-0" style="margin-top: 56px">
        ...
        <div class="col-8 ">
            <center>
                <h1 class="py-3">Update Playlist</h1>
                <h3>
                ...
                <form method="post">
                    <table class="table table-dark table-striped">
                        ...
                        <tr>
                            <td>
                                <input type="text"
                                       class="form-control ps-2" name="nameSong" id="nameSong" value="${playlist.nameSong}"
                                       placeholder="Name of the song">
                            </td>
                            <td>
                                <select style="width: 100%; height: 35px;border-radius: .375rem;" name="singerId" id="singerId">
                            ...
                            <td>
                                <select style="width: 100%; height: 35px;border-radius: .375rem;" name="typeId" id="typeId">
                        ...
                        <section style="width: 5rem;height: 40px;border-radius: 150px;" class="bg-dark mt-0 mb-2 me-3 float-end d-flex align-items-center justify-content-center">
                            <div class="circle long">
                                <input style="border: none" class="bg-dark text-white" type="submit" value="Change">
                            </div>
                        </section>
                    </table>
                </form>
