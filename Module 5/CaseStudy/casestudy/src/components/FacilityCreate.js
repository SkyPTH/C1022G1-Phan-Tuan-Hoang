                                        ...
                                        <ul className="dropdown-menu">
                                            {
                                                facilitiesType.map((facilities, index) => (
                                                        <li key={index}>
                                                            <Field component="a" name="facilitiesType" value={facilities.id}
                                    ...
                                    <div className="d-flex justify-content-center mt-3">
                                        <table className="" style={{width: 500}}>
                                            ...
                                            <tr style={{height: 60}}>
                                                ...
                                                <td>
                                                    <Field component="select" name="facilitiesType"
                                                           className="form-select" id="floatingSelect"
                                                           aria-label="Floating label select example">
                                                        {
                                                            facilitiesType.map((facilitiesTypes) => (
                                                                <option key={facilitiesTypes.id}
                                                                        value={facilitiesTypes.id}>{facilitiesTypes.name}</option>
                                                            ))
                                            ...
                                            <tr style={facility === 'Biệt thự' || facility === 'Căn hộ' ?
                                                ...
                                                <td>
                                                    <Field component="select" name="standard" className="form-select"
                                                           id="floatingSelect"
                                                           aria-label="Floating label select example">
                                                        {
                                                            facilityStandard.map((facilityStandards) => (
                                                                <option key={facilityStandards.id}
                                                                        value={facilityStandards.id}>{facilityStandards.name}</option>
                                                            ))
                                                        }
                                                    </Field>
                                                </td>
                                            ...
                                            }
                                            {
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <ErrorMessage name="poolarea" className="text-danger"
                                                                  component="span"/>
                                                </tr>
                                            }
                                            <tr style={facility === 'Biệt thự' || facility === 'Căn hộ' ?
                                            ...
                                            </tr>
                                            {
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <ErrorMessage name="numberFloors" className="text-danger"
                                                                  component="span"/>
                                                </tr>
                                            }
                                            {
                                            ...
                                            </tr>
                                            {
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <ErrorMessage name="serviceFree" className="text-danger"
                                                                  component="span"/>
                                                </tr>
                                            }
                                            ...
                                            <tr style={{height: 60}}>
                                                ...
                                                <td>
                                                    <Field component="select" multiple name="facilityService"
                                                           className="form-select" id="floatingSelect"
                                                           aria-label="Floating label select example" size={3}>
                                                        {
                                                            facilityService.map((facilityServices) => (
                                                                <option key={facilityServices.id}
                                                                        value={facilityServices.id}>{facilityServices.name}</option>
                                                            ))
                                                        }
                                                    </Field>
                                                </td>
