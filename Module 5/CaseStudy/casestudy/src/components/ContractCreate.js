                                    ...
                                    <div className="col-6">
                                        ...
                                        <div className="d-flex justify-content-center mt-3">
                                            <table className="" style={{width: 500}}>
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th><ErrorMessage name="contractCode" className="text-danger"
                                                                      component="span"/></th>
                                                </tr>
                                                <tr style={{height: 60}}>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <Field component="select" name="customerInfo"
                                                ...
                                                <tr style={{height: 60}}>
                                                    ...
                                                    <td>
                                                        <Field component="select" name="facilityInfo"
                                                               className="form-select" id="floatingSelect"
                                                               aria-label="Floating label select example">
                                                            {
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th><ErrorMessage name="dateStart" className="text-danger"
                                                                      component="span"/></th>
                                                </tr>
                                                <tr style={{height: 60}}>
                                                    <th>
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th><ErrorMessage name="dateEnd" className="text-danger"
                                                                      component="span"/></th>
                                                </tr>
                                                <tr style={{height: 60}}>
                                                    <th>
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th><ErrorMessage name="price" className="text-danger"
                                                                      component="span"/></th>
                                                </tr>
                                                <tr style={{height: 60}}>
                                                    <th>
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th><ErrorMessage name="totalPrice" className="text-danger"
                                                                      component="span"/></th>
                                                </tr>
                                                {
                                                    isSubmitting ? <Oval
