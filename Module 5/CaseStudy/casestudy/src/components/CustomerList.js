                        ...
                        >
                            <Form>
                                <div className="form-group float-end w-75" style={{
                                    ...
                                    <button type="submit" className="btn btn-secondary float-start rounded-pill">Tìm
                                        kiếm
                                    </button>
                                </div>
                            </Form>
                        ...
                        <tbody>
                        {
                            customers.map((customer, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        <NavLink className="btn btn-primary" to={`/customer-edit/${customer.id}`}><i
                                            className="ti-pencil-alt"/></NavLink>
                                    </td>
                                    <td>
                                        <button
                                            type="button"
