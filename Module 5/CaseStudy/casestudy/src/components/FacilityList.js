                        ...
                        <div className="col-4 d-flex justify-content-center" key={facilities.id}>
                            <div className="card shadow mb-5 mt-2">
                                ...
                                <div className="card-body">
                                    ...
                                    <NavLink to={`/facility-edit/${facilities.id}`} className="btn btn-primary"><i
                                        className="ti-pencil-alt"></i></NavLink>
                                    <button onClick={() => getIdDelete(facilities.id, facilities.name)}
                                            data-bs-toggle="modal"
                                            data-bs-target="#facilityDelete" className="btn btn-danger ms-2"><i
                                        className="ti-trash"></i></button>
                                    <NavLink to={`/facility-detail/${facilities.id}`} className="float-end btn"><i
                                        className="ti-info fs-3 fw-bold"></i></NavLink>
                                </div>
                            </div>
                        </div>
                    ))
